...
The following table shows the probability mass function per percentage block of voting intentions for the [poll average](average.html) for Parti radical de gauche–La Convention (*).
...
![Graph with seats probability mass function not yet produced](average-seats-pmf-partiradicaldegauche–laconvention.png "Seats Probability Mass Function")

The following table shows the probability mass function per seat for the [poll average](average.html) for Parti radical de gauche–La Convention (*).
